...
function InvoiceTemplate({
  ...
  return (
    <article className="w-full max-w-5xl mx-auto px-2 sm:px-4 lg:px-6">
      <Card className="h-full shadow-none">
        <CardHeader className="pb-6 sm:pb-8">
          <CardTitle
            className={clsx("border-b border-border pb-4 sm:pb-6", {
              "flex flex-col gap-4 sm:gap-6 lg:gap-0 lg:flex-row justify-between lg:items-end":
                children,
            })}
          >
              ...
              <Table className="w-full" style={{ tableLayout: "fixed" }}>
                <TableHeader>
                  <TableRow className="border-b border-border">
                    <TableHead className="font-medium text-foreground text-left py-2 px-2 w-[120px]">
                      Nazwa
                    </TableHead>
                    <TableHead className="font-medium text-foreground text-left py-2 px-2 w-[140px]">
                      Opis
                    </TableHead>
                    <TableHead className="font-medium text-foreground text-right py-2 px-2 w-[90px]">
                      Cena netto
                    </TableHead>
                    <TableHead className="font-medium text-foreground text-center py-2 px-2 w-[60px]">
                      Ilość
                    </TableHead>
                    <TableHead
                      className={cn(
                        "font-medium text-foreground text-center py-2 px-2 w-[50px]",
                        invoice.exemptTax && "hidden"
                      )}
                    >
                      VAT
                    </TableHead>
                    <TableHead className="font-medium text-foreground text-right py-2 px-2 w-[100px]">
                      Wartość netto
                    </TableHead>
                    <TableHead
                      className={cn(
                        "font-medium text-foreground text-right py-2 px-2 w-[80px]",
                        invoice.exemptTax && "hidden"
                      )}
                    >
                      Kwota VAT
                  ...
                  {invoice.products.map((product, index) => (
                    ...
                    >
                      <TableCell className="py-2 px-2">
                        <span className="font-medium text-foreground text-xs break-words block">
                          {product.name}
                        </span>
                      </TableCell>
                      <TableCell className="py-2 px-2">
                      ...
                      <TableCell
                        className={cn(
                          "py-2 px-2 text-center text-muted-foreground text-xs",
                          invoice.exemptTax && "hidden"
                        )}
                      >
                      ...
                      <TableCell
                        className={cn(
                          "py-2 px-2 text-right text-muted-foreground text-xs",
                          invoice.exemptTax && "hidden"
                        )}
                      >
